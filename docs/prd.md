...
- Left side navigation items:\n  - RoomSaathi Properties: On click, display RoomSaathi Verified properties
  - For Owner: On click, show dedicated section for property owners displaying functionalities provided for owners, including management software, website listing services, etc.
