...
export default function PropertyFormWizard({ property, onCancel }: PropertyFormWizardProps) {
  ...
  const handlePropertySave = async (data: any) => {
    console.log('handlePropertySave called with data:', data);
    console.log('isEdit:', isEdit, 'property?.id:', property?.id);
    ...
    try {
      ...
      console.log('Property created with ID:', result.data.id);
      toast({
        title: 'Success',
