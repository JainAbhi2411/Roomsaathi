...
import { MapPin, IndianRupee, Wifi, Car, Utensils, Shield, Users, UserCheck } from 'lucide-react';
        ...
        <CardContent className="p-4">
          ...
          {property.suitable_for && property.suitable_for.length > 0 && (
            <div className="flex flex-wrap gap-1 mb-3">
              {property.suitable_for.slice(0, 3).map((type) => (
                <Badge
                  key={type}
                  variant="outline"
              ...
              {property.suitable_for.length > 3 && (
